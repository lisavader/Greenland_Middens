...
```{r, include=FALSE}
packages <- c("dplyr","magrittr","stringr","tidyr","tibble","janitor","ggplot2","vegan","zCompositions","compositions","ggsignif","circlize")
...
```{r}
ggplot(plantgenus_PCs,aes(PC1,PC2,colour=factor(group)))+
  geom_point()+
...
```{r}
ggplot(mammalfamily_PCs,aes(PC1,PC2,colour=factor(group)))+
  geom_point()+
...
anno=rowAnnotation(depth=middendata$displacement)
row_groups <- middendata$site_cat
col_fun = colorRamp2(c(0,15), 
    c("white", "red"))
heatmap = Heatmap(genus_clr_top10plant, right_annotation = anno, show_row_names = FALSE, row_order = middendata_ordered$long_id, row_split = row_groups, column_names_rot = 45, col = col_fun, name = "clr value",row_gap = unit(3, "mm"),heatmap_width = unit(23, "cm"), heatmap_height = unit(13, "cm"))
draw(heatmap)
```
...
heatmap = Heatmap(family_clr_top10mammal, right_annotation = anno, show_row_names = FALSE, row_order = middendata_ordered$long_id, row_split = row_groups, column_names_rot = 45, col = col_fun,name = "clr value",row_gap = unit(3, "mm"),heatmap_width = unit(23, "cm"), heatmap_height = unit(13, "cm"))
draw(heatmap)
```
